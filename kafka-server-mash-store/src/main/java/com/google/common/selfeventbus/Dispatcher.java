...
abstract class Dispatcher {
  ...
  abstract void dispatch(Object event, Iterator<com.google.common.selfeventbus.Subscriber> subscribers);
  ...
  private static final class PerThreadQueuedDispatcher extends Dispatcher {
    ...
    @Override
    void dispatch(Object event, Iterator<com.google.common.selfeventbus.Subscriber> subscribers) {
      checkNotNull(event);
    ...
    private static final class Event {
      ...
      private final Iterator<com.google.common.selfeventbus.Subscriber> subscribers;

      private Event(Object event, Iterator<com.google.common.selfeventbus.Subscriber> subscribers) {
        this.event = event;
  ...
  private static final class LegacyAsyncDispatcher extends Dispatcher {
    ...
    private static final class EventWithSubscriber {
      private final Object event;
      private final com.google.common.selfeventbus.Subscriber subscriber;

      private EventWithSubscriber(Object event, com.google.common.selfeventbus.Subscriber subscriber) {
        this.event = event;
